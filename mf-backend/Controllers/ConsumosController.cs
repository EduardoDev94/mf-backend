...
namespace mf_backend.Controllers
{
    ...
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricacao,Data,Valor,Km,Tipo,VeiculoId")] Consumo consumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricacao,Data,Valor,Km,Tipo,VeiculoId")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
